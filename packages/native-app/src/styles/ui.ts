...
export const appTypography = {
  ...
  artifactTabActiveLabel: 'text-[15px] font-semibold text-foreground',
  artifactTabInactiveLabel: `text-[15px] font-semibold ${TEXT_MUTED}`,
  artifactChatTitle: 'text-[17px] font-medium text-foreground',
  ...
  composerMentionTitle: 'text-[13px] font-medium text-foreground',
  composerMentionMeta: 'text-[11px] text-muted',
  composerMentionEmpty: `px-3 py-2.5 text-[13px] ${TEXT_MUTED}`,
  composerMentionError: 'px-3 py-2.5 text-[13px] text-red-500',
...
export const appLayout = {
  artifactChatList: 'gap-5',
  artifactChatRow: 'px-1 py-1',
  ...
  composerInputRegion: 'min-h-[60px] px-1',
  ...
  composerMentionSurface:
    'overflow-hidden rounded-[20px] border border-foreground/10 bg-default py-1.5 shadow-none',
  composerMentionList: 'gap-1',
  composerMentionRow: 'flex-row items-center gap-2.5 px-3 py-2.5',
