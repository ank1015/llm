...
describe("DbService", () => {
	...
	describe("getMessages", () => {
		...
		it("should filter by time range", () => {
			...
			DbService.saveMessage(createMockMessage("anthropic", { id: "msg-1", timestamp: baseTime - 10000 }));
			DbService.saveMessage(createMockMessage("anthropic", { id: "msg-2", timestamp: baseTime }));
			DbService.saveMessage(createMockMessage("anthropic", { id: "msg-3", timestamp: baseTime + 10000 }));
		...
		it("should order by timestamp descending", () => {
			const baseTime = Date.now();
			DbService.saveMessage(createMockMessage("anthropic", { id: "msg-old", timestamp: baseTime - 10000 }));
