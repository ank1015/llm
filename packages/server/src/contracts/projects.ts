...
import { SessionSummaryDtoSchema } from './session.js';
...
export type UpdateProjectImageRequest = Static<typeof UpdateProjectImageRequestSchema>;
...
export type ProjectFileIndexEntryDto = Static<typeof ProjectFileIndexEntrySchema>;
