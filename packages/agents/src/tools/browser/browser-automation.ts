import { createBashTool, createEditTool, createReadTool, createWriteTool } from '../index.js';
...
export function createBrowserAutomateTools(workingDir: string): AgentTool[] {
  const tools = [
