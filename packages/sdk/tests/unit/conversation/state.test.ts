...
describe('Conversation State Management', () => {
  ...
  describe('Message Management', () => {
    ...
    it('should update message', () => {
      ...
      const content = ((conversation.state.messages[0] as UserMessage).content[0] as TextContent)
        .content;
  ...
  describe('Usage and Limits', () => {
    ...
    it('should update usage when appending assistant messages', () => {
      ...
      const assistantMsg2 = {
        ...assistantMsg,
        usage: { ...assistantMsg.usage, cost: { ...assistantMsg.usage.cost, total: 0.1 } },
      };
    ...
    it('should preserve usage when resetting? (Currently reset clears state including usage?)', () => {
      ...
      const assistantMsg: Message = {
        ...
        usage: {
          ...
          cacheRead: 0,
          cacheWrite: 0,
          cost: { total: 1, input: 0, output: 0, cacheRead: 0, cacheWrite: 0 },
        },
        stopReason: 'stop',
        timestamp: 0,
        duration: 0,
