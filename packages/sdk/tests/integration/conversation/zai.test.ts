...
describe('Zai Conversation Integration', () => {
  it('should use calculator tool correctly', async () => {
    ...
    const model = MODELS.zai['glm-4.7'];
  ...
  it('should handle reasoning/thinking mode', async () => {
    ...
    // GLM-4.7 with thinking enabled should have thinking content
  ...
  it('should emit thinking events during reasoning', async () => {
    ...
    // GLM-4.7 with thinking enabled should produce thinking for this query
