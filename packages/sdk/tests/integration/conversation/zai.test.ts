...
describe('Zai Conversation Integration', () => {
  const zaiApiKey = process.env['ZAI_API_KEY'];
  const zaiModel = MODELS.zai['glm-5'];

  it.skipIf(!zaiApiKey || !zaiModel)(
    'should use calculator tool correctly',
    async () => {
  ...
  it.skipIf(!zaiApiKey || !zaiModel)(
    'should emit all agent events correctly during tool use',
    async () => {
      const conversation = new Conversation();
  ...
  it.skipIf(!zaiApiKey || !zaiModel)(
    'should handle reasoning/thinking mode',
    async () => {
      const conversation = new Conversation();
      ...
      // GLM-5 with thinking enabled should have thinking content
  ...
  it.skipIf(!zaiApiKey || !zaiModel)(
    'should emit thinking events during reasoning',
    async () => {
      const conversation = new Conversation();
      ...
      // GLM-5 with thinking enabled should produce thinking for this query
  ...
  it.skipIf(!zaiApiKey || !zaiModel)(
    'should handle preserved thinking across turns',
    async () => {
      const conversation = new Conversation();
