...
describe('Anthropic Conversation Integration', () => {
  ...
  const anthropicModel = MODELS.anthropic['claude-haiku-4-5'];

  it.skipIf(!anthropicApiKey || !anthropicModel)(
  ...
  it.skipIf(!anthropicApiKey || !anthropicModel)(
    ...
    async () => {
      ...
      const pirateWords = ['ahoy', 'matey', 'arr', 'aye', 'ye', 'ship', 'sea', 'captain', 'sailor'];
