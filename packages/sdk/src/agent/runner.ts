import { Api, AssistantResponse, AssistantToolCall, BaseAssistantMessage, Context, Message, OptionsForApi, ToolResultMessage, AgentEvent, AgentLoopConfig, AgentTool, AgentToolResult, QueuedMessage, ToolExecutionContext } from "@ank1015/llm-types";
...
export class DefaultAgentRunner implements AgentRunner {
    ...
    private async executeSingleTool(
        ...
        try {
            ...
            const errorDetails: ToolResultMessage['error'] = e instanceof Error
