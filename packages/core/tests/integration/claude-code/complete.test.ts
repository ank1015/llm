...
import type { ClaudeCodeProviderOptions, Context, Model } from '@ank1015/llm-types';

describe('Claude Code Complete Integration', () => {
        ...
        messages: [
          {
            ...
            id: 'test-1',
            content: [
              { type: 'text', content: 'Think through this step by step: what is 15 * 23?' },
            ],
          },
        ],
      };
