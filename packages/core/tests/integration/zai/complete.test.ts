...
describe("Zai Complete Integration", () => {
	...
	describe("thinking/reasoning", () => {
		...
		it("should preserve thinking with clear_thinking: false", async () => {
			const context: Context = {
				messages: [
					{
						role: "user",
	...
	describe("error handling", () => {
		it("should handle API errors gracefully", async () => {
			...
			const result = await completeZai(model, context, { apiKey: "invalid-key-12345" }, "test-msg-10");
		...
		it("should handle abort signal", async () => {
			...
			const result = await completeZai(model, context, { apiKey, signal: controller.signal }, "test-msg-11");
