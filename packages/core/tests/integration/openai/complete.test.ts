...
describe("OpenAI Complete Integration", () => {
	...
	describe("error handling", () => {
		it("should handle API errors gracefully", async () => {
			...
			const result = await completeOpenAI(model, context, { apiKey: "invalid-key-12345" }, "test-msg-10");
		...
		it("should handle abort signal", async () => {
			...
			const result = await completeOpenAI(model, context, { apiKey, signal: controller.signal }, "test-msg-11");
