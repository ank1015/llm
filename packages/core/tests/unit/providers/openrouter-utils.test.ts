...
import {
  ...
  convertTools,
  createClient,
  getMockOpenRouterMessage,
  mapStopReason,
} from '../../../src/providers/openrouter/utils.js';
...
describe('OpenRouter Utils', () => {
  describe('createClient', () => {
    ...
    const mockModel: Model<'openrouter'> = {
      id: 'openai/gpt-4o',
    ...
    it('should set custom headers from model', () => {
      const customModel: Model<'openrouter'> = {
        ...mockModel,
  ...
  describe('buildOpenRouterMessages', () => {
    ...
    describe('system prompt', () => {
      it('should convert system prompt to system role', () => {
        ...
        const result = buildOpenRouterMessages(mockModel, context);
    ...
    describe('assistant messages', () => {
      it('should convert OpenRouter assistant messages (preserves native)', () => {
        ...
        const assistantMessage: BaseAssistantMessage<'openrouter'> = {
          role: 'assistant',
          id: 'msg-1',
          api: 'openrouter',
          model: mockModel,
      ...
      describe('cross-provider handoff', () => {
        it('should convert Google assistant text response to OpenRouter format', () => {
        ...
        it('should convert cross-provider tool calls to OpenRouter format', () => {
          const assistantMessage: BaseAssistantMessage<'google'> = {
            role: 'assistant',
            id: 'msg-1',
            api: 'google',
  ...
  describe('buildParams', () => {
    ...
    it('should not add tools when model does not support function_calling', () => {
      const modelNoTools: Model<'openrouter'> = {
        ...mockModel,
        tools: [],
      };
      const tool: Tool = {
  ...
  describe('getMockOpenRouterMessage', () => {
    it('should return a valid ChatCompletion structure', () => {
      const mock = getMockOpenRouterMessage('openai/gpt-4o', 'test-req-123');
      expect(mock.id).toBe('chatcmpl-test-req-123');
      expect(mock.object).toBe('chat.completion');
      expect(mock.model).toBe('openai/gpt-4o');
