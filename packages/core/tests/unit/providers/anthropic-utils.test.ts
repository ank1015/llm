	...
	describe("getResponseAssistantResponse", () => {
		...
		it("should extract thinking blocks", () => {
			const response: AnthropicMessage = {
				...
				type: "message",
				role: "assistant",
				content: [{ type: "thinking", thinking: "Let me think..." } as any],
				model: "claude-sonnet-4-5",
				stop_reason: "end_turn",
				stop_sequence: null,
				usage: {
		...
		it("should extract redacted thinking blocks", () => {
			const response: AnthropicMessage = {
				...
				type: "message",
				role: "assistant",
				content: [{ type: "redacted_thinking", data: "summary" } as any],
				model: "claude-sonnet-4-5",
				stop_reason: "end_turn",
				stop_sequence: null,
				usage: {
		...
		it("should handle multiple content blocks", () => {
			const response: AnthropicMessage = {
				...
				type: "message",
				role: "assistant",
				content: [{ type: "thinking", thinking: "Thinking..." } as any, { type: "text", text: "Answer" }],
				model: "claude-sonnet-4-5",
				stop_reason: "end_turn",
				stop_sequence: null,
				usage: {
