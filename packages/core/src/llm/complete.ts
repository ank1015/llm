...
export async function complete<TApi extends Api>(
	...
	switch (model.api) {
		...
		case "openai":
			return completeOpenAI(model as Model<"openai">, context, options as OptionsForApi<"openai">, id) as Promise<
				BaseAssistantMessage<TApi>
			>;

		case "google":
			return completeGoogle(model as Model<"google">, context, options as OptionsForApi<"google">, id) as Promise<
				BaseAssistantMessage<TApi>
			>;
		...
		case "zai":
			return completeZai(model as Model<"zai">, context, options as OptionsForApi<"zai">, id) as Promise<
				BaseAssistantMessage<TApi>
			>;

		case "kimi":
			return completeKimi(model as Model<"kimi">, context, options as OptionsForApi<"kimi">, id) as Promise<
				BaseAssistantMessage<TApi>
			>;
