...
/**
 * Structured assistant error details.
 */
...
export interface BaseAssistantMessage<TApi extends Api> {
  ...
  id: string;
  model: Model<TApi>;
  /** Structured error details when generation fails or is aborted */
  error?: AssistantError;
  /** Legacy error string retained for backwards compatibility */
  errorMessage?: string;
  timestamp: number;
