...
import type { Api, BaseAssistantMessage, MessageNode, ToolResultMessage } from '@ank1015/llm-types';
...
describe('buildWorkingTraceModel', () => {
  it('keeps streaming response-only text inline and never promotes it to finalResponseText', () => {
  ...
  it('only promotes trailing response blocks to the final response for completed turns', () => {
    const assistant = createAssistantMessage({
