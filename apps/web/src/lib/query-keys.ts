...
export const queryKeys = {
  ...
  projects: {
    ...
    fileIndexRoot: (projectId: string) => [...projectScope(projectId), 'file-index'] as const,
  ...
  artifacts: {
    ...
    skills: (ctx: ArtifactContext) => [...artifactScope(ctx), 'skills'] as const,
    checkpoints: (ctx: ArtifactContext) => [...artifactScope(ctx), 'checkpoints'] as const,
