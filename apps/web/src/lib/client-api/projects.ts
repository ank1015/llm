...
export type RenameArtifactPathInput = Omit<
  RenameArtifactPathRequest,
  "path" | "newName"
> & {
  path: string;
...
export async function renameProject(
  ...
  return apiRequestJson<ProjectDto>(
    `${PROJECTS_BASE}/${encodeURIComponent(projectId)}/name`,
    {
      method: "PATCH",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify(input),
...
export async function getArtifactFiles(
  ctx: ArtifactContext,
): Promise<ArtifactFilesListResponse> {
...
export async function getArtifactCheckpoints(
  ...
  return apiRequestJson<ArtifactCheckpointListResponse>(
...
export async function renameArtifactPath(
  ...
  return apiRequestJson<RenameArtifactPathResponse>(
    `${buildArtifactBase(ctx)}/path/rename`,
    {
      method: "PATCH",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({
