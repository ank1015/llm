...
It talks to the server backend over HTTP and WebSocket APIs, defaulting to the current browser origin in production and `http://localhost:8001` during development, tests, and server-side fallback.
...
- development/test/server fallback: `http://localhost:8001`
